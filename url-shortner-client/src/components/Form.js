...
class Form extends React.Component {
    ...
    onSubmit = async (event) => {
        ...
        //Be sure to change url-shortner.com to your domain
        var generatedKey = nanoid(5);
        var generatedURL = "url-shortner.com/" + generatedKey

        if (this.state.preferedAlias !== '') {
            generatedKey = this.state.preferedAlias
            generatedURL = "url-shortner.com/" + this.state.preferedAlias
        }
                    ...
                    <div className="form-group">
                        ...
                        <div className="input-group mb-3">
                            <div className="input-group-prepend">
                                <span className="input-group-text">url-shortner.com/</span>
                            </div>
                            <input
                                id="preferedAlias"
                                onChange={this.handleChange}
